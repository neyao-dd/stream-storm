...
public class EsMonthBolt implements IRichBolt {

	private transient static Log log = LogFactory.getLog(EsMonthBolt.class);
	...
	public EsMonthBolt(String target) {
		boltConfig.put(ES_RESOURCE_WRITE, target);
	}

	public EsMonthBolt(String target, Map configuration, int tickFreq) {
